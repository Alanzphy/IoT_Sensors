    ...
    <BentoCard variant="light">
      <div className="flex items-start gap-3 mb-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-[#6E6359]">{area.size || area.hectares || 0} ha</p>
        </div>
      </div>
...
export function PropertyDetail() {
  ...
  return (
    <div className="min-h-screen p-4 md:p-6 lg:p-8">
      <div className="mb-6">
        <h1 className="text-2xl md:text-3xl text-[#2C2621] mb-2">{selectedProperty.name || "Propiedad"}</h1>
      ...
      <BentoCard variant="light" className="mb-6">
        ...
        <div className="h-[300px] bg-[#E2D4B7] rounded-[24px] flex items-center justify-center relative overflow-hidden">
          ...
          <div className="text-center z-10">
            ...
            <p className="text-[#6E6359]">Mapa con {propertyAreas.length} sensores activos</p>
          </div>
        </div>
      </BentoCard>
