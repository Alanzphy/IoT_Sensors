    ...
    <BentoCard variant="light">
      <div className="flex items-start gap-3 mb-4">
        ...
        <div className="flex-1">
          <h3 className="text-lg text-[var(--text-main)] font-medium">{area.name}</h3>
          <p className="text-sm text-[var(--text-muted)]">{area.size || area.hectares || 0} ha</p>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <div>
          <div className="flex items-center justify-between mb-1">
            <span className="text-sm text-[var(--text-muted)]">Humedad</span>
...
export function PropertyDetail() {
  ...
  if (!selectedProperty) {
    return <div className="p-8">No property selected</div>;
  }
  ...
  return (
    <div className="min-h-screen p-4 md:p-6 lg:p-8">
      <div className="mb-6">
        <h1 className="text-2xl md:text-3xl text-[var(--text-main)] mb-2">{selectedProperty.name || "Propiedad"}</h1>
      ...
      <BentoCard variant="light" className="mb-6">
        <h3 className="text-lg text-[var(--text-main)] mb-4">Ubicación de Sensores</h3>
        <div className="h-[300px] bg-[var(--card-sand)] rounded-[24px] flex items-center justify-center relative overflow-hidden">
          ...
          <div className="text-center z-10">
            ...
            <p className="text-[var(--text-muted)]">Mapa con {propertyAreas.length} sensores activos</p>
          </div>
        </div>
      </BentoCard>
      ...
      {/* Areas grid */}
      <div className="mb-4">
        <h2 className="text-xl text-[var(--text-main)] mb-4">Áreas de Riego</h2>
      </div>
