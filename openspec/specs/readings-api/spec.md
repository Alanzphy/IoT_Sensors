...
Defines the read-side API for sensor data consumed by the frontend: history with date filters and pagination, latest reading, availability metadata, priority-status semaphores, and data export (CSV/XLSX/PDF).
